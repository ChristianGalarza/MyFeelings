package galarza.christian.myfeelings

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.util.Log
import galarza.christian.myfeelings.utilities.CustomBarDrawable
import galarza.christian.myfeelings.utilities.CustomCircleDrawable
import galarza.christian.myfeelings.utilities.Emociones
import galarza.christian.myfeelings.utilities.JSONFile
...
//            guardar()
    ...
    fun actualizarGrafica(){
        ...
        graphVeryHappy.background=CustomBarDrawable(this,Emociones("Feliz",pH,R.color.orange,happy))
        graphVeryHappy.background=CustomBarDrawable(this,Emociones("Neutral",pN,R.color.greenie,neutral))
        graphVeryHappy.background=CustomBarDrawable(this,Emociones("Triste",pS,R.color.blue,sad))
        graphVeryHappy.background=CustomBarDrawable(this,Emociones("Muy triste",pVS,R.color.deepBlue,verySad))
